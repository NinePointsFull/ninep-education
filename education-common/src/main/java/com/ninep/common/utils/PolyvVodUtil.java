...
import com.ninep.common.callback.CallbackVodAuthCode;
import com.ninep.common.exception.BaseException;
import com.ninep.common.vod.PolyvSign;
import com.ninep.common.vod.PolyvSignResponse;
import com.ninep.common.vod.request.VideoInfoAsyncBatchUploadRequest;
import com.ninep.common.vod.response.CategoryAddResponse;
import com.ninep.common.vod.response.CategoryViewResponse;
import com.ninep.common.vod.response.PolyvGetKeyframeResponse;
import com.ninep.common.vod.response.VideoInfoResponse;
...
public final class PolyvVodUtil {
    ...
    private static final String KEY = "ninep-education";
    ...
    public static void main(String[] args) {
        System.out.println(getUserMain("b5f94860ca", "0yH51c1zTy"));
    }
    ...
    public static Boolean watermarkSetting(String cataid, String userId, String image, String watermarkLocation, String secretKey) {
        ...
        paramMap.put("sign", getSha1Sign(paramMap, secretKey));
        // 请求
        String result = com.ninep.common.utils.HttpUtil.postFile(requestUrl, paramMap, fileMap, "utf-8");

...
public class AdminBizTest {
    ...
    // admin-client
    private static String addressUrl = "http://192.168.0.106:8080/xxl-job-admin/";
    ...
    public void registry() throws Exception {
        ...
        RegistryParam registryParam = new RegistryParam(RegistryConfig.RegistType.EXECUTOR.name(), "xxl-job-executor-example", "192.168.0.106:9999");
